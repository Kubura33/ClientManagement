...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/search', [\App\Http\Controllers\ImplementationController::class, 'search'])->name('search');
    ...
    Route::patch('/paket', [PackageController::class, 'update'])->name('paket.update');
