...
const sortedFuncs = computed(() => {
    ...
    return allFunctionalities.slice().sort((a, b) => {
        ...
        if (a.selected !== b.selected) {
            return a.selected ? -1 : 1; // selected comes first
        }
...
<template>
    ...
    <div class="min-h-screen pt-0 -mt-20 p-6  flex">
        <div class="container max-w-screen-lg mx-auto bg-white p-8 rounded-lg  transform scale-75">
            <!-- Form Title -->
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="relative bg-gray-50 p-4 rounded-md border border-gray-300 shadow-sm">
                        ...
                        <div class="text-gray-600 h-52 overflow-y-auto pr-2">
                            ...
                            >
                                <div class="flex flex-row-reverse gap-2">
                                    <label class="form-check-label"
                                           :class="{'text-gray-400': !func.selected, 'text-black': func.selected}"
